...
Click on the _Preview.gif_ link in the file repository, or scroll down to view a course I authored, shown through screen-recording of a learner in their web browser. 
...
* Determination of pertinent data, per
  * organizational strategy (e.g. work needs)
  * learner audience
* Translation of legal and technical concepts into accessible content

### Course Design
Authorship of this project required skillful weaving of ___all___ of the following:
* Structured delivery
* Visual and stylistic cohesion
* Engaging learning, especially through visual-recognition
* Embedded assessment and quantitative methods
...
* GIMP (image & screen capture editing)
